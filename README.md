...
- **Правила стиля** — document-start (`---`), запрет пробелов в конце строки, перевод строки в конце файла, запрет нескольких пустых строк подряд (опционально, конфиг `style:`)
